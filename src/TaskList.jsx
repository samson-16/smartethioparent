  ...
  return (
    <table className="table-fixed w-full">
      <thead className="border-t-2 border-b-4 border-gray-300">
        <tr>
          <th className="w-1/3 px-4 py-2 text-[#0F6CBF] text-left">Subject</th>
          <th className="w-1/3 px-4 py-2 text-[#0F6CBF] text-left">Type</th>
          <th className="w-1/3 px-4 py-2 text-[#0F6CBF] text-left">Due Date</th>
        </tr>
      </thead>
      <tbody>
