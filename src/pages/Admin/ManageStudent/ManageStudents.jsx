 ...
 */
  ...
  const handleAddParentInfo = () => {
    ...
    .then((response) => {
      ...
      // const newParent = dis(response.data);
      // setRows([...rows, newParent]);
      handleClose();
    })
    .catch((error) => {
  ...
  return (
    <section className="flex flex-col items-center">
      ...
      >
        <Button variant="contained" sx={{backgroundColor:'#1D24CA'}} onClick={handleOpenStudentForm}>Add Student</Button>
        <Button variant="contained" sx={{backgroundColor:"#0802A3"}} onClick={handleOpenParentForm}>Add Parent</Button>
      </Box>
      <DataGrid
        rows={rows}
        columns={columns}
